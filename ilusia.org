...
TODO: к всем модулям. довести каждый модуль до разумного минимума а если в моем конфиге есть полезное больше разумного минимума добавить 
...
**** org-mode
:PROPERTIES:
:header-args:emacs-lisp+: :tangle ./modules/ilusia-module-org-basic.el
:END:
...
this is a temporary version but  ilusia will have that for some time
#+begin_src emacs-lisp
...
*** html-mode
:PROPERTIES:
:header-args:emacs-lisp+: :tangle ./modules/ilusia-module-html.el
:END:
...
*** js-mode
:PROPERTIES:
:header-args:emacs-lisp+: :tangle ./modules/ilusia-module-js.el
:END:
...
*** markdown-mode
:PROPERTIES:
:header-args:emacs-lisp+: :tangle ./modules/ilusia-module-markdown.el
:END:
...
*** typescript-mode
:PROPERTIES:
:header-args:emacs-lisp+: :tangle ./modules/ilusia-module-typescript.el
:END:
...
* Extensions
TODO: добавить все что есть из моего конфига по смыслу являющеся extensions
** Mode line
:PROPERTIES:
